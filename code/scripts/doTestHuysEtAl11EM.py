...
def main(argv):
    ...
    parser.add_argument("--subjects_filenames", help="subjects filenanes",
                        default="../../../gillan_model_assignment/subjects_filename.txsubjects_filename.txt")
    ...
    # get arguments
    subjects_filenames = args.subjects_filenames
    ...
    for subject_filename in subjects_filenames:
        subject_data = utils.getSubjectData(subject_dirname=subject_dirname,
                                            subject_filename=subject_filename,
                                            columns_names=columns_names,
                                            index_colname=index_colname,
                                            prev_line_string=prev_line_string)
        model = models.DawRLmodel(alpha_0=alpha_0,
                                  alpha_bounds=alpha_bounds,
                                  beta_stage2_0=beta_stage2_0,
                                  beta_stage2_bounds=beta_stage2_bounds, 
                                  beta_MB_0=beta_MB_0,
                                  beta_MB_bounds=beta_MB_bounds, 
                                  beta_MF0_0=beta_MF0_0,
                                  beta_MF0_bounds=beta_MF0_bounds, 
                                  beta_MF1_0=beta_MF1_0,
                                  beta_MF1_bounds=beta_MF1_bounds, 
                                  beta_stick_0=beta_stick_0,
                                  beta_stick_bounds=beta_stick_bounds, 
        ...
        named_models_list.append({"label": subject_filename, "model": model})
